  ...
  for(i=0;i<Sent_Data_Num;i++)
  {
    switch(USART0_Sent_Choose_Data[i])
    {
      /* 以下部分用于观察参数曲线 */
			...
			case 0: data[i] = YawMotor_PosPID.Target;
			break;
			case 1: data[i] = YawMotor_PosPID.Current;
			break;
			case 2: data[i] = YawMotor_PosPID.Out;
			break;
			case 3: data[i] = YawMotor_SpdPID.Target;
			break;
			case 4: data[i] = YawMotor_SpdPID.Current;
			break;
			case 5: data[i] = YawMotor_SpdPID.Out;
			break;
//			case 6: data[i] = TrunkMotor1_SpdPID.Current;
//			break;
      default:break;
	  /* 以上部分用于观察参数曲线 */
    }
